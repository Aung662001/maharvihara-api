...
export const create = async (data) => {
  let database_data = {};
  database_data.name = data.name;
  database_data.active = data.status.value;
  database_data.parent_id = data.parentstockgroup.id
    ? data.parentstockgroup.id
    : 0;
  database_data.created_date = new Date();
  database_data.image = "";
  database_data.stock_location_id = 0;
  database_data.branch_id = 0;
  try {
...
export const update = async (data) => {
  try {
    let database_data = {};
    database_data.id = data.id;
    database_data.name = data.name;
    database_data.active = data.status.value;
    database_data.parent_id = data.parentstockgroup.id
      ? data.parentstockgroup.id
      : 0;
    database_data.modified_date = new Date();
    database_data.image = "";
    database_data.stock_location_id = 0;
    database_data.branch_id = 0;
